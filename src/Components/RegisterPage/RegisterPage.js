    ...
    <div id='register'>
		      ...
		      <div id="overlay" className="absolute absolute--fill bg-white o-70 z-unset"></div>
			      <div className="relative pa4 pa5-m">
			        ...
			        <div>
			          <div className="mb3" id="registerName">
			            <label className="db f6 black-80 ttu ph2 mb2">Name</label>
			            <input 
		            		type="text"
		            		id="username"
		            		name="username" 
			          ...
			          <div className="mb4" id="registerPassword">
			          ...
			          <div id="registerButton" className='pb4'>
		                ...
		                type="submit"
			              value="Register"
			              onClick = { () => {
				            	registerData.name = document.getElementById('username').value;
